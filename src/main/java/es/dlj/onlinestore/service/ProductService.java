...
public class ProductService {
    ...
    public void init() {
        ...
        products.save(new Product("product4", 40.0f, "description4", Product.productType.NEW, 40, new LinkedList<>()));
        products.save(new Product("product5", 50.0f, "description5", Product.productType.NEW, 50, new LinkedList<>()));
    }
